...
#         return True
#     if player:
#         p_starting_row, p_starting_col = find_player_position()
#         if p_starting_row != "No p":
#             matrix[p_starting_row][p_starting_col] = "."
#         winner = True
#
#
# def find_bomb():
...
#         matrix[player_row][player_col], matrix[player_movement_row][player_movement_col] = ".", "P"
